...
#define CMDLINE_PARSER_VERSION "0.42"
#endif
...
struct gengetopt_args_info
{
  ...
  char * mode_arg;	/**< @brief mode of transfer (default='Send').  */
  char * mode_orig;	/**< @brief mode of transfer original value given at command line.  */
  const char *mode_help; /**< @brief mode of transfer help description.  */
  int num_values_arg;	/**< @brief number of values to communicate in tests (default='4096').  */
  char * num_values_orig;	/**< @brief number of values to communicate in tests original value given at command line.  */
  const char *num_values_help; /**< @brief number of values to communicate in tests help description.  */
  ...
  char * send_pattern_arg;	/**< @brief order in which elements will be marked ready (default='Linear').  */
  char * send_pattern_orig;	/**< @brief order in which elements will be marked ready original value given at command line.  */
  const char *send_pattern_help; /**< @brief order in which elements will be marked ready help description.  */
