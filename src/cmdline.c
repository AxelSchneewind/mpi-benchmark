...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_field (args_info->max_partition_size_given, (void *)(args_info->max_partition_size_arg), &(args_info->max_partition_size_orig));
  args_info->max_partition_size_arg = 0;
  free_multiple_field (args_info->min_thread_count_given, (void *)(args_info->min_thread_count_arg), &(args_info->min_thread_count_orig));
  args_info->min_thread_count_arg = 0;
  free_multiple_field (args_info->max_thread_count_given, (void *)(args_info->max_thread_count_arg), &(args_info->max_thread_count_orig));
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->modes_given)
    {
      fprintf (stderr, "%s: '--modes' ('-m') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->modes_given, args_info->modes_min, args_info->modes_max, "'--modes' ('-m')"))
     error_occurred = 1;
  
  if (! args_info->min_partition_size_given)
    {
      fprintf (stderr, "%s: '--min-partition-size' ('-p') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->min_partition_size_given, args_info->min_partition_size_min, args_info->min_partition_size_max, "'--min-partition-size' ('-p')"))
     error_occurred = 1;
  
  if (! args_info->max_partition_size_given)
    {
      fprintf (stderr, "%s: '--max-partition-size' ('-P') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->max_partition_size_given, args_info->max_partition_size_min, args_info->max_partition_size_max, "'--max-partition-size' ('-P')"))
     error_occurred = 1;
  
  if (! args_info->min_thread_count_given)
    {
      fprintf (stderr, "%s: '--min-thread-count' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->min_thread_count_given, args_info->min_thread_count_min, args_info->min_thread_count_max, "'--min-thread-count' ('-t')"))
     error_occurred = 1;
  
  if (! args_info->max_thread_count_given)
    {
      fprintf (stderr, "%s: '--max-thread-count' ('-T') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->max_thread_count_given, args_info->max_thread_count_min, args_info->max_thread_count_max, "'--max-thread-count' ('-T')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * modes_list = NULL;
  struct generic_list * min_partition_size_list = NULL;
  struct generic_list * max_partition_size_list = NULL;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'b':	/* the log of the buffer size in bytes.  */
          ...
          break;
        case 'i':	/* the number of iterations per test case.  */
        ...
        case 'I':	/* the number of warmup iterations per test case.  */
          ...
          break;
        case 'm':	/* a comma separated list containing the benchmarks to run.  */
        
          if (update_multiple_arg_temp(&modes_list, 
              &(local_args_info.modes_given), optarg, 0, "all", ARG_STRING,
              "modes", 'm',
              additional_error))
            goto failure;
        
          break;
        case 'p':	/* the logs of the minimal partition sizes for each mode.  */
        
          if (update_multiple_arg_temp(&min_partition_size_list, 
              &(local_args_info.min_partition_size_given), optarg, 0, "0", ARG_INT,
              "min-partition-size", 'p',
              additional_error))
            goto failure;
        
          break;
        case 'P':	/* the logs of the maximal partition sizes for each mode.  */
        ...
        case 't':	/* log2 of the minimal thread counts for each mode.  */
          ...
          break;
        case 'T':	/* log2 of the maximal thread counts for each mode.  */
        
          if (update_multiple_arg_temp(&max_thread_count_list, 
              &(local_args_info.max_thread_count_given), optarg, 0, "0", ARG_INT,
              "max-thread-count", 'T',
              additional_error))
            goto failure;
  ...
  update_multiple_arg((void *)&(args_info->modes_arg),
    &(args_info->modes_orig), args_info->modes_given,
    local_args_info.modes_given, &multiple_default_value,
    ARG_STRING, modes_list);
  update_multiple_arg((void *)&(args_info->min_partition_size_arg),
    &(args_info->min_partition_size_orig), args_info->min_partition_size_given,
    local_args_info.min_partition_size_given, 0,
    ARG_INT, min_partition_size_list);
  update_multiple_arg((void *)&(args_info->max_partition_size_arg),
  ...
  args_info->min_partition_size_given += local_args_info.min_partition_size_given;
  local_args_info.min_partition_size_given = 0;
  args_info->max_partition_size_given += local_args_info.max_partition_size_given;
  local_args_info.max_partition_size_given = 0;
  args_info->min_thread_count_given += local_args_info.min_thread_count_given;
  local_args_info.min_thread_count_given = 0;
  args_info->max_thread_count_given += local_args_info.max_thread_count_given;
  local_args_info.max_thread_count_given = 0;
...
failure:
  free_list (modes_list, 1 );
  free_list (min_partition_size_list, 0 );
  free_list (max_partition_size_list, 0 );
